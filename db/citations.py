"""db.citations — Citation network analytics: ego, co-citation, bibcoupling, centrality, sleeping beauties, half-life, communities, main path, temporal evolution, reading path, author co-citation."""
