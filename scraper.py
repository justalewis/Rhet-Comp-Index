...
# (Reflections scraper removed 2026-06-11: the journal moved to CROSSREF_JOURNALS
# in May 2026 after Penn State Libraries deposited full metadata + reference
# lists. The 'reflections' strategy was dead code from then on; see git history
